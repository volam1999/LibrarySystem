<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="error404.aspx.cs" Inherits="LibrarySystem.error404" %>
    ...
    <div class="container">
        <div class="left-section">
            <div class="inner-content">
                ...
                <h2><a href="#" onclick="history.go(-1)" style="color:chartreuse; text-decoration:none; padding-left:160px;">GO BACK!</a></h2>
            </div>
        </div>
